	...
	if not self.choose:
	 if x > 8:
        ...
        if self.choose and x < 9:  #选中棋子，并且移到棋盘内
           self.choosed_chess.canvas.move(self.choosed_chess.oval,(x-self.choosed_chess.x)*self.choosed_chess.l,(y-self.choosed_chess.y-0.5)*self.choosed_chess.l)#移动选中的棋子
           self.choosed_chess.canvas.move(self.choosed_chess.word,(x-self.choosed_chess.x)*self.choosed_chess.l,(y-self.choosed_chess.y-0.5)*self.choosed_chess.l)
	   self.choosed_chess.not_choose()
